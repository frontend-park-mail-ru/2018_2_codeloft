...
export default class Main extends BaseView {
	build() {
		return new Promise((resolve) => {
			this.template = `<Button {{class=main-page__button}} {{text=Single Player}} {{click=goSinglePlayer}} {{needAuth=true}}>
                         ...
                         <Button {{class=main-page__button}} {{text=Profile}} {{click=goProfile}} {{needAuth=true}}>`;
